...
echo "    1. npm publish npm/tolkin-darwin-arm64    # publishes @tolkin/darwin-arm64"
echo "    2. npm publish npm/tolkin-darwin-x64      # publishes @tolkin/darwin-x64"
echo "    3. npm publish npm/tolkin-linux-x64       # publishes @tolkin/linux-x64"
echo "    4. npm publish npm/tolkin-linux-arm64     # publishes @tolkin/linux-arm64"
echo "    5. npm publish npm/tolkin-win32-x64       # publishes @tolkin/win32-x64"
echo "    6. npm publish npm/tolkin                 # publishes @tolkin/cli"
